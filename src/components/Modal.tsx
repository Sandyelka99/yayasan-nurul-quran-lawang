            ...
            <form onSubmit={handleNext} className="p-6">
              ...
              <div className="mb-6">
                ...
                <div className="relative">
                  ...
                  <input
                    type="number"
                    disabled={fosterPackage ? true : false}
                    value={amount}
                    onChange={(e) => {
            ...
            <div className="p-6">
              ...
              <div className="flex gap-3">
                ...
                >
                 ...
                 <button
                  onClick={() => {
                    alert("Terima kasih. Konfirmasi donasi Anda berhasil disiapkan. Pada versi produksi, data ini akan dikirim ke admin keuangan Yayasan Nurul Quran.");
                    handleClose();
                  }}
