...
// Fixed 8 campaign items precisely as requested by the user, mapped to updated categories
export const STAGE_CAMPAIGNS: Campaign[] = [
  ...
  },
  {
    ...
    title: "Program Makan & Khidmat Sosial Santri",
    category: "program-sosial",
    description: "Membantu kebutuhan makan dan santunan sosial santri dhuafa agar mereka dapat belajar dan menghafal Al-Qur’an dengan tenang.",
    targetAmount: 30000000,
  ...
  },
  {
    ...
    title: "Dukung Dakwah Digital Yayasan",
    category: "dukung-dakwah",
    description: "Mendukung penyebaran dakwah digital, streaming kajian, pembinaan, dan program syiar Yayasan Nurul Quran.",
...
export default function DonationWakafPage({ 
  ...
  const categories = [
    ...
    { id: "program-sosial", label: "Program Sosial" },
    { id: "wakaf-alquran", label: "Wakaf Al-Qur’an" },
    { id: "wakaf-pembangunan", label: "Wakaf Pembangunan" },
    { id: "dukung-dakwah", label: "Dukung Dakwah Digital" },
  ];
  ...
  return (
    <div className="bg-[#fcfdfe] min-h-screen text-brand-dark-900 pb-20">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-brand-dark-950 via-brand-dark-900 to-brand-teal-950 text-white pt-32 pb-24 sm:pt-40 sm:pb-32 border-b border-brand-teal-900/40">
      ...
      {/* EXCLUSIVE SECTION 2.5: ORANG TUA ASUH BANNER CALL TO ACTION */}
      <section className="py-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-gradient-to-r from-brand-teal-900 to-[#0e3b4a] rounded-3xl p-8 sm:p-12 relative overflow-hidden text-white border border-brand-teal-800 shadow-xl flex flex-col md:flex-row items-center justify-between gap-8 md:gap-14">
          <div className="absolute top-0 right-0 w-80 h-80 bg-brand-teal-500/10 rounded-full blur-[80px] pointer-events-none" />
          <div className="space-y-4 max-w-2xl text-left">
            <span className="inline-block text-[10px] sm:text-xs font-extrabold tracking-widest text-[#d8be75] bg-[#d8be75]/10 border border-[#d8be75]/20 px-3 py-1 rounded-full uppercase">
              Program Unggulan Sosial Santri
            </span>
            <h3 className="text-xl sm:text-2xl font-extrabold tracking-tight">
              Program Orang Tua Asuh Penghafal Al-Qur’an
            </h3>
            <p className="text-xs sm:text-sm text-gray-300 font-semibold leading-relaxed">
              Program dukungan rutin untuk membantu anak-anak penghafal Al-Qur’an mendapatkan pembinaan, pendidikan, dan kebutuhan belajar yang lebih layak.
            </p>
          </div>
          <div className="flex-shrink-0">
            <button
              onClick={() => onNavigate("orang-tua-asuh")}
              className="py-3 px-6 sm:py-3.5 sm:px-8 bg-[#d8be75] hover:bg-[#c9b068] text-[#0e3b4a] rounded-xl font-extrabold text-xs sm:text-sm shadow-md transition-all cursor-pointer whitespace-nowrap inline-flex items-center gap-2"
            >
              Jadi Orang Tua Asuh
